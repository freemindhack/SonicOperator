...
int fft_x86(jshort *input,jint *output,int count);
...
Java_sdu_embedded_Sonic_core_FFT_fft_x86(JNIEnv *env, jobject obj, jshortArray jshort_array, jint count)
{
    ...
    rs = fft(input,output,count,intel);
